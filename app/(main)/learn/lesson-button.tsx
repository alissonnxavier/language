...
// import {} from "react-circular-progressbar/dist/style.css"
                    ...
                    <div className="h-[102px] w-[102px] relative">
                        ...
                        <CircularProgressbarWithChildren value={Number.isNaN(percentage) ? 0 : percentage}
                            ...
                            <Button
                                ...
                                <Icon className={cn("h-10 w-10", locked ? "fill-neutral-400 stroke-neutral-400" : "fill-primary-foreground text-primary-foreground",
